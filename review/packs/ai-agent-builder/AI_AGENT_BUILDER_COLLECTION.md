# AI_AGENT_BUILDER_COLLECTION.md

## Purpose
Turn AI into an agent systems architect for role design and tool orchestration.

---

## Domain
Agent design, memory, tool routing, fallback logic
